var Kf=Object.defineProperty;var kc=Object.getOwnPropertySymbols;var Gf=Object.prototype.hasOwnProperty,zf=Object.prototype.propertyIsEnumerable;var Cc=(n,e,t)=>e in n?Kf(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t,Ac=(n,e)=>{for(var t in e||(e={}))Gf.call(e,t)&&Cc(n,t,e[t]);if(kc)for(var t of kc(e))zf.call(e,t)&&Cc(n,t,e[t]);return n};import{r as Hf,z as Wf,o as De,c as Ne,F as Dc,A as Nc,p as Qf,b as Yf,y as hl,a as Y,t as Rc}from"./vendor.3299f13a.js";import{b as xn,d as ps,e as st,f as En,g as Or,h as dl,_ as dr,a as fr,c as Xf}from"./gcp.e8f23423.js";import{_ as Jf}from"./index.3cef2ebd.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function aI(n){oI(n,(e,t)=>new Bf(e,t,new nI)),n.registerVersion(Z_,eI)}aI(ui);const cI={apiKey:"AIzaSyCuVNZo9j6IK_azbbaGrHxWCq1SQIUOVKQ",authDomain:"fazweb-fd34e.firebaseapp.com",projectId:"fazweb-fd34e",storageBucket:"fazweb-fd34e.appspot.com",messagingSenderId:"753269671192",appId:"1:753269671192:web:20df071a7705c0e59b8a6d",measurementId:"G-WV78ZQVTRQ"},uI=ui.initializeApp(cI),lI=uI.firestore(),hI=lI.collection("portfolios").orderBy("id"),dI=()=>{const n=Hf([]),e=hI.onSnapshot(t=>{n.value=t.docs.map(s=>Ac({id:s.id},s.data()))});return Wf(e),n};var Tn="/assets/bootstrap.e0f47d52.png",fI="/assets/attendance.7dda4d96.jpg",pI="/assets/catering.f73b0e83.jpg",mI="/assets/ajt.0d4eba2e.jpg",gI="/assets/employee.71900390.jpg",yI="/assets/cabai.3f328955.jpg",wI="/assets/kjm.2fa33584.jpg",vI="/assets/adn.f629b9c2.jpg",bI="/assets/aim.a5f280ce.jpg";const _I={name:"portfolio",data:function(){return{portfolios:dI()}},components:{}},Ki=n=>(Qf("data-v-a82b4984"),n=n(),Yf(),n),II={class:"w-full"},TI=Ki(()=>Y("div",{class:"flex flex-col space-y-2 items-center justify-center text-lg text-center md:text-left md:mt-20"},[Y("label",{class:"text-5xl font-semibold tracking-wider text-center"},"Portfolio"),Y("label",null,"My personal and team projects, always there if you need.")],-1)),xI={key:0,class:"flex flex-col md:flex-row space-x-0 md:space-x-10 hover:shadow-md rounded-2xl duration-300"},EI={class:"md:w-6/12 w-full relative"},SI=["src"],kI=Ki(()=>Y("label",{class:"bg-white/30 font-semibold border px-4 py-2 rounded-lg bottom-5 left-5 absolute shadow-xl backdrop-blur dark:text-gray-700"},"2022",-1)),CI={class:"md:w-6/12 w-full flex flex-col space-y-10 my-auto md:py-4 py-2 px-4 md:px-4"},AI={class:"flex flex-col space-y-1 md:space-y-4 mt-2 md:mt-0"},DI={class:"md:text-4xl text-3xl font-semibold tracking-wider"},NI=["innerHTML"],RI=hl('<div class="flex flex-col space-y-4" data-v-a82b4984><h1 class="text-xl md:text-2xl font-semibold" data-v-a82b4984>Tech Stack</h1><div class="flex flex-row px-4 space-x-8 overflow-x-auto" data-v-a82b4984><img src="'+xn+'" class="object-contain w-12 snap-center shrink-0" data-v-a82b4984><img src="'+ps+'" class="object-contain w-12 snap-center shrink-0" data-v-a82b4984><img src="'+st+'" class="object-contain w-12 snap-center shrink-0" data-v-a82b4984><img src="'+En+'" class="object-contain w-12 snap-center shrink-0" data-v-a82b4984><img src="'+Or+'" class="object-contain w-12 snap-center shrink-0" data-v-a82b4984></div></div>',1),OI={key:1,class:"flex flex-col md:flex-row-reverse space-x-0 md:space-x-10 hover:shadow-md rounded-2xl duration-300 md:space-x-reverse"},PI={class:"md:w-6/12 w-full relative"},LI=["src"],MI=Ki(()=>Y("label",{class:"bg-white/30 backdrop-blur shadow-lg font-semibold px-4 py-2 rounded-lg bottom-5 right-5 absolute dark:text-gray-700"},"2021",-1)),UI={class:"md:w-6/12 w-full flex flex-col space-y-10 my-auto md:p-4 p-2"},FI={class:"flex flex-col space-y-1 md:space-y-4 mt-2 md:mt-0"},BI={class:"md:text-4xl text-3xl font-semibold tracking-wider"},VI=["innerHTML"],qI={class:"flex flex-col space-y-4"},$I=Ki(()=>Y("h1",{class:"text-xl md:text-2xl font-semibold"},"Tech Stack",-1)),jI={class:"flex flex-row px-4 space-x-8 snap-x overflow-x-auto"},KI={key:0,src:xn,class:"object-contain w-12 snap-center shrink-0"},GI={key:1,src:ps,class:"object-contain w-12 snap-center shrink-0"},zI={key:2,src:Tn,class:"object-contain w-12 snap-center shrink-0"},HI={key:3,src:st,class:"object-contain w-12 snap-center shrink-0"},WI={key:4,src:En,class:"object-contain w-12 snap-center shrink-0"},QI={key:5,src:dl,class:"object-contain w-12 snap-center shrink-0"},YI={key:6,src:Or,class:"object-contain w-12 snap-center shrink-0"},XI=hl('<div class="flex flex-col md:flex-row space-x-0 md:space-x-10 hover:shadow-md rounded-2xl duration-300" data-v-a82b4984><div class="md:w-6/12 w-full relative" data-v-a82b4984><img class="h-80 object-cover rounded-2xl" src="'+fI+'" data-v-a82b4984><label class="bg-white/30 font-semibold border px-4 py-2 rounded-lg bottom-5 left-5 absolute shadow-xl backdrop-blur dark:text-gray-700" data-v-a82b4984>2022</label></div><div class="md:w-6/12 w-full flex flex-col space-y-10 my-auto md:p-4 p-2" data-v-a82b4984><div class="flex flex-col space-y-4" data-v-a82b4984><h1 class="md:text-4xl text-3xl font-semibold tracking-wider" data-v-a82b4984>24Slides Attendance App</h1><label class="md:text-lg text-base" data-v-a82b4984>Work as a front end to help develop applications based on laravel, Tailwind, Livewire framework. This application is used to recap employee attendance</label></div><div class="flex flex-col space-y-4" data-v-a82b4984><h1 class="text-xl md:text-2xl font-semibold" data-v-a82b4984>Tech Stack</h1><div class="flex flex-row px-4 space-x-8 snap-x overflow-x-auto" data-v-a82b4984><img src="'+xn+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+ps+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+st+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+En+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+Or+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+dl+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984></div></div></div></div><div class="flex flex-col md:flex-row space-x-0 md:space-x-10 hover:shadow-md rounded-2xl duration-300 flex-row-reverse space-x-reverse" data-v-a82b4984><div class="md:w-6/12 w-full relative" data-v-a82b4984><img class="h-80 object-cover rounded-2xl" src="'+pI+'" data-v-a82b4984><label class="bg-white/30 backdrop-blur shadow-lg font-semibold px-4 py-2 rounded-lg bottom-5 right-5 absolute dark:text-gray-700" data-v-a82b4984>2021</label></div><div class="md:w-6/12 w-full flex flex-col space-y-10 my-auto md:p-4 p-2" data-v-a82b4984><div class="flex flex-col space-y-1 md:space-y-4 mt-2 md:mt-0" data-v-a82b4984><h1 class="md:text-4xl text-3xl font-semibold tracking-wider" data-v-a82b4984>24Slides Catering App</h1><label class="md:text-lg text-base" data-v-a82b4984>Work as a front end to help develop applications based on laravel, Tailwind, Livewire. This application is used to order food by employees and is accepted by the caterer</label></div><div class="flex flex-col space-y-4" data-v-a82b4984><h1 class="text-xl md:text-2xl font-semibold" data-v-a82b4984>Tech Stack</h1><div class="flex flex-row px-4 space-x-8 snap-x overflow-x-auto" data-v-a82b4984><img src="'+xn+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+ps+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+st+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+En+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+Or+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984></div></div></div></div><div class="flex flex-col md:flex-row space-x-0 md:space-x-10 hover:shadow-md rounded-2xl duration-300" data-v-a82b4984><div class="md:w-6/12 w-full relative" data-v-a82b4984><img class="h-80 object-cover w-full rounded-2xl" src="'+mI+'" data-v-a82b4984><label class="bg-white/30 font-semibold border px-4 py-2 rounded-lg bottom-5 left-5 absolute shadow-xl backdrop-blur dark:text-gray-700" data-v-a82b4984>2020</label></div><div class="md:w-6/12 w-full flex flex-col space-y-10 my-auto md:p-4 p-2" data-v-a82b4984><div class="flex flex-col space-y-4" data-v-a82b4984><h1 class="md:text-4xl text-3xl font-semibold tracking-wider" data-v-a82b4984>CV Anugerah Jaya Tekindo</h1><label class="md:text-lg text-base" data-v-a82b4984>Work as full stack web developer for making 3 website including coffee shop cashier, printing cashier, and company profile</label></div><div class="flex flex-col space-y-4" data-v-a82b4984><h1 class="text-xl md:text-2xl font-semibold" data-v-a82b4984>Tech Stack</h1><div class="flex flex-row px-4 space-x-8 snap-x overflow-x-auto" data-v-a82b4984><img src="'+dr+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+fr+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+Tn+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+st+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984></div></div></div></div><div class="flex space-x-10 flex-col md:flex-row hover:shadow-md rounded-2xl duration-300 flex-row-reverse space-x-reverse" data-v-a82b4984><div class="md:w-6/12 w-full relative" data-v-a82b4984><img class="h-full object-cover rounded-2xl" src="'+gI+'" data-v-a82b4984><label class="bg-white/30 backdrop-blur shadow-lg font-semibold px-4 py-2 rounded-lg bottom-5 right-5 absolute dark:text-gray-700" data-v-a82b4984>2019</label></div><div class="md:w-6/12 w-full flex flex-col space-y-10 my-auto md:p-4 p-2" data-v-a82b4984><div class="flex flex-col space-y-1 md:space-y-4 mt-2 md:mt-0" data-v-a82b4984><h1 class="md:text-4xl text-3xl font-semibold tracking-wider" data-v-a82b4984>24Slides Employee App</h1><label class="md:text-lg text-base" data-v-a82b4984>Work as a front end to help develop applications based on laravel &amp; Bootstrap framework. This application is to calculate employee salaries based on attendance and other components</label></div><div class="flex flex-col space-y-4" data-v-a82b4984><h1 class="text-xl md:text-2xl font-semibold" data-v-a82b4984>Tech Stack</h1><div class="flex flex-row px-4 space-x-8 snap-x overflow-x-auto" data-v-a82b4984><img src="'+xn+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+Tn+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+st+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+En+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+Xf+'" class="object-contain w-24" data-v-a82b4984></div></div></div></div><div class="flex flex-col md:flex-row space-x-0 md:space-x-10 hover:shadow-md rounded-2xl duration-300 flex-row space-x" data-v-a82b4984><div class="md:w-6/12 w-full relative" data-v-a82b4984><img class="h-full w-full object-cover rounded-2xl" src="'+yI+'" data-v-a82b4984><label class="bg-white/30 font-semibold border px-4 py-2 rounded-lg bottom-5 left-5 absolute shadow-xl backdrop-blur dark:text-gray-700" data-v-a82b4984>2019</label></div><div class="md:w-6/12 w-full flex flex-col space-y-10 my-auto md:p-4 p-2" data-v-a82b4984><div class="flex flex-col space-y-1 md:space-y-4 mt-2 md:mt-0" data-v-a82b4984><h1 class="md:text-4xl text-3xl font-semibold tracking-wider" data-v-a82b4984>Chilies Decision Support System for BPTP</h1><label class="md:text-lg text-base" data-v-a82b4984>Making thesis website as full stack web developer for making decission support system with Case Based Reasoning metode for BPTP JATIM, See here for detail <code data-v-a82b4984><a href="http://eprints.itn.ac.id/3818/" data-v-a82b4984>e-Journal</a></code></label></div><div class="flex flex-col space-y-4" data-v-a82b4984><h1 class="text-xl md:text-2xl font-semibold" data-v-a82b4984>Tech Stack</h1><div class="flex flex-row px-4 space-x-8 snap-x overflow-x-auto" data-v-a82b4984><img src="'+dr+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+fr+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+Tn+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+st+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984></div></div></div></div><div class="flex space-x-10 flex-col md:flex-row hover:shadow-md rounded-2xl duration-300 flex-row-reverse space-x-reverse" data-v-a82b4984><div class="md:w-6/12 w-full relative" data-v-a82b4984><img class="h-full object-cover rounded-2xl w-full" src="'+wI+'" data-v-a82b4984><label class="bg-white/30 backdrop-blur shadow-lg font-semibold px-4 py-2 rounded-lg bottom-5 right-5 absolute dark:text-gray-700" data-v-a82b4984>2018</label></div><div class="md:w-6/12 w-full flex flex-col space-y-10 my-auto md:p-4 p-2" data-v-a82b4984><div class="flex flex-col space-y-4" data-v-a82b4984><h1 class="md:text-4xl text-3xl font-semibold tracking-wider" data-v-a82b4984>Decision Support System for KJM Trenggale</h1><label class="md:text-lg text-base" data-v-a82b4984>Making thesis website as full stack web developer for making decission support system with Analytical Hierarchy Process metode, See here for detail <code data-v-a82b4984><a href="http://eprints.itn.ac.id/3818/" data-v-a82b4984>e-Journal</a></code></label></div><div class="flex flex-col space-y-4" data-v-a82b4984><h1 class="text-xl md:text-2xl font-semibold" data-v-a82b4984>Tech Stack</h1><div class="flex flex-row px-4 space-x-8 snap-x overflow-x-auto" data-v-a82b4984><img src="'+dr+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+fr+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+Tn+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+st+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984></div></div></div></div><div class="flex flex-col md:flex-row space-x-0 md:space-x-10 hover:shadow-md rounded-2xl duration-300 flex-row space-x" data-v-a82b4984><div class="md:w-6/12 w-full relative" data-v-a82b4984><img class="h-80 object-cover rounded-2xl w-full" src="'+vI+'" data-v-a82b4984><label class="bg-white/30 font-semibold border px-4 py-2 rounded-lg bottom-5 left-5 absolute shadow-xl backdrop-blur dark:text-gray-700" data-v-a82b4984>2022</label></div><div class="md:w-6/12 w-full flex flex-col space-y-10 my-auto md:p-4 p-2" data-v-a82b4984><div class="flex flex-col space-y-1 md:space-y-4 mt-2 md:mt-0" data-v-a82b4984><h1 class="md:text-4xl text-3xl font-semibold tracking-wider" data-v-a82b4984>ADN Homepage</h1><label class="md:text-lg text-base" data-v-a82b4984>ADN dev. Homepage, See here for detail <a href="https://fajarfaz.github.io/adn-front/" data-v-a82b4984><code data-v-a82b4984>github.io</code></a></label></div><div class="flex flex-col space-y-4" data-v-a82b4984><h1 class="text-xl md:text-2xl font-semibold" data-v-a82b4984>Tech Stack</h1><div class="flex flex-row px-4 space-x-8 snap-x overflow-x-auto" data-v-a82b4984><img src="'+xn+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+ps+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+En+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984></div></div></div></div><div class="flex space-x-10 flex-col md:flex-row hover:shadow-md rounded-2xl duration-300 flex-row-reverse space-x-reverse" data-v-a82b4984><div class="md:w-6/12 w-full relative" data-v-a82b4984><img class="h-80 object-cover rounded-2xl w-full" src="'+bI+'" data-v-a82b4984><label class="bg-white/30 backdrop-blur shadow-lg font-semibold px-4 py-2 rounded-lg bottom-5 right-5 absolute dark:text-gray-700" data-v-a82b4984>2015</label></div><div class="md:w-6/12 w-full flex flex-col space-y-10 my-auto md:p-4 p-2" data-v-a82b4984><div class="flex flex-col space-y-1 md:space-y-4 mt-2 md:mt-0" data-v-a82b4984><h1 class="md:text-4xl text-3xl font-semibold tracking-wider" data-v-a82b4984>Agro Indonesia Machinery</h1><label class="md:text-lg text-base" data-v-a82b4984>Web for product promotion, sales information and company profile, See here <a href="pusatmesinmalang.com" data-v-a82b4984><code data-v-a82b4984>pusatmesinmalang.com</code></a></label></div><div class="flex flex-col space-y-4" data-v-a82b4984><h1 class="text-xl md:text-2xl font-semibold" data-v-a82b4984>Tech Stack</h1><div class="flex flex-row px-4 space-x-8 snap-x overflow-x-auto" data-v-a82b4984><img src="'+dr+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+fr+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+Tn+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984><img src="'+st+'" class="object-contain w-12 nap-center shrink-0" data-v-a82b4984></div></div></div></div>',8);function JI(n,e,t,s,r,i){return De(),Ne("main",II,[TI,(De(!0),Ne(Dc,null,Nc(n.portfolios,o=>(De(),Ne("div",{class:"grid gap-20 md:gap-28 my-20",key:o.id,"track-by":"portfolio.id"},[o.id%2!=0?(De(),Ne("div",xI,[Y("div",EI,[Y("img",{class:"h-full object-fill w-full rounded-2xl",src:"../src/assets/images/"+o.image},null,8,SI),kI]),Y("div",CI,[Y("div",AI,[Y("h1",DI,Rc(o.title),1),Y("label",{class:"md:text-lg text-base",innerHTML:o.desc},null,8,NI)]),RI])])):(De(),Ne("div",OI,[Y("div",PI,[Y("img",{class:"h-full w-full object-cover rounded-2xl",src:"../src/assets/images/"+o.image},null,8,LI),MI]),Y("div",UI,[Y("div",FI,[Y("h1",BI,Rc(o.title),1),Y("label",{class:"md:text-lg text-base",innerHTML:o.desc},null,8,VI)]),Y("div",qI,[$I,Y("div",jI,[(De(!0),Ne(Dc,null,Nc(o.tech,a=>(De(),Ne("div",null,[a=="laravel"?(De(),Ne("img",KI)):a=="tailwind"?(De(),Ne("img",GI)):a=="bootstrap"?(De(),Ne("img",zI)):a=="mysql"?(De(),Ne("img",HI)):a=="alpine"?(De(),Ne("img",WI)):a=="gcp"?(De(),Ne("img",QI)):(De(),Ne("img",YI))]))),256))])])])]))]))),128)),XI])}var s0=Jf(_I,[["render",JI],["__scopeId","data-v-a82b4984"]]);export{s0 as default};
