var Kf=Object.defineProperty;var Rc=Object.getOwnPropertySymbols;var Gf=Object.prototype.hasOwnProperty,zf=Object.prototype.propertyIsEnumerable;var Oc=(n,e,t)=>e in n?Kf(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t,Pc=(n,e)=>{for(var t in e||(e={}))Gf.call(e,t)&&Oc(n,t,e[t]);if(Rc)for(var t of Rc(e))zf.call(e,t)&&Oc(n,t,e[t]);return n};import{y as Hf,z as Wf,o as x,c as k,b as Qf,A as Yf,w as Xf,p as Jf,q as Zf,F as ur,B as hr,a as R,t as mn}from"./vendor.8b5240a1.js";import{b as Vo,d as qo,e as $o,f as jo,h as Gn,_ as Ko,c as Go,a as zo,i as ep,j as tp,g as Ho}from"./firebase.66a1418e.js";import{_ as np}from"./index.7b3196e6.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cg={["no-app"]:"No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()",["invalid-app-argument"]:"firebase.{$appName}() takes either no argument or a Firebase App instance."},Vc=new ei("app-compat","Firebase",Cg);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ag(n){const e={},t={__esModule:!0,initializeApp:i,app:r,registerVersion:Ye,setLogLevel:Eh,onLog:Th,apps:null,SDK_VERSION:ri,INTERNAL:{registerComponent:a,removeApp:s,useAsService:c,modularAPIs:xg}};t.default=t,Object.defineProperty(t,"apps",{get:o});function s(u){delete e[u]}function r(u){if(u=u||$t,!Mc(e,u))throw Vc.create("no-app",{appName:u});return e[u]}r.App=n;function i(u,h={}){const l=bh(u,h);if(Mc(e,l.name))return e[l.name];const d=new n(l,t);return e[l.name]=d,d}function o(){return Object.keys(e).map(u=>e[u])}function a(u){const h=u.name,l=h.replace("-compat","");if(jt(u)&&u.type==="PUBLIC"){const d=(g=r())=>{if(typeof g[l]!="function")throw Vc.create("invalid-app-argument",{appName:h});return g[l]()};u.serviceProps!==void 0&&Dr(d,u.serviceProps),t[l]=d,n.prototype[l]=function(...g){return this._getService.bind(this,h).apply(this,u.multipleInstances?g:[])}}return u.type==="PUBLIC"?t[l]:null}function c(u,h){return h==="serverAuth"?null:h}return t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Be={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class zi{constructor(e,t){this.data=e,this.contentType=t||null}}function Oh(n,e){switch(n){case Be.RAW:return new zi(Ph(e));case Be.BASE64:case Be.BASE64URL:return new zi(Lh(n,e));case Be.DATA_URL:return new zi(hm(e),lm(e))}throw na()}function Ph(n){const e=[];for(let t=0;t<n.length;t++){let s=n.charCodeAt(t);if(s<=127)e.push(s);else if(s<=2047)e.push(192|s>>6,128|s&63);else if((s&64512)===55296)if(!(t<n.length-1&&(n.charCodeAt(t+1)&64512)===56320))e.push(239,191,189);else{const i=s,o=n.charCodeAt(++t);s=65536|(i&1023)<<10|o&1023,e.push(240|s>>18,128|s>>12&63,128|s>>6&63,128|s&63)}else(s&64512)===56320?e.push(239,191,189):e.push(224|s>>12,128|s>>6&63,128|s&63)}return new Uint8Array(e)}function um(n){let e;try{e=decodeURIComponent(n)}catch{throw ds(Be.DATA_URL,"Malformed data URL.")}return Ph(e)}function Lh(n,e){switch(n){case Be.BASE64:{const r=e.indexOf("-")!==-1,i=e.indexOf("_")!==-1;if(r||i)throw ds(n,"Invalid character '"+(r?"-":"_")+"' found: is it base64url encoded?");break}case Be.BASE64URL:{const r=e.indexOf("+")!==-1,i=e.indexOf("/")!==-1;if(r||i)throw ds(n,"Invalid character '"+(r?"+":"/")+"' found: is it base64 encoded?");e=e.replace(/-/g,"+").replace(/_/g,"/");break}}let t;try{t=cm(e)}catch{throw ds(n,"Invalid character found")}const s=new Uint8Array(t.length);for(let r=0;r<t.length;r++)s[r]=t.charCodeAt(r);return s}class Mh{constructor(e){this.base64=!1,this.contentType=null;const t=e.match(/^data:([^,]+)?,/);if(t===null)throw ds(Be.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const s=t[1]||null;s!=null&&(this.base64=dm(s,";base64"),this.contentType=this.base64?s.substring(0,s.length-7):s),this.rest=e.substring(e.indexOf(",")+1)}}function hm(n){const e=new Mh(n);return e.base64?Lh(Be.BASE64,e.rest):um(e.rest)}function lm(n){return new Mh(n).contentType}function dm(n,e){return n.length>=e.length?n.substring(n.length-e.length)===e:!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ay="storage-compat";function cy(n,{instanceIdentifier:e}){const t=n.getProvider("app-compat").getImmediate(),s=n.getProvider("storage").getImmediate({identifier:e});return new zh(t,s)}function uy(n){const e={TaskState:xe,TaskEvent:Om,StringFormat:Be,Storage:zh,Reference:it};n.INTERNAL.registerComponent(new at(ay,cy,"PUBLIC").setServiceProps(e).setMultipleInstances(!0)),n.registerVersion(iy,oy)}uy(ii);var hy="firebase",ly="9.6.8";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nv{constructor(e){this.user=e,this.ke=new Wa,this.uid=e.uid||""}addToCollectionParentIndex(e,t){if(!this.ke.has(t)){const s=t.lastSegment(),r=t.popLast();e.addOnCommittedListener(()=>{this.ke.add(t)});const i={collectionId:s,parent:oe(r)};return $u(e).put(i)}return p.resolve()}getCollectionParents(e,t){const s=[],r=IDBKeyRange.bound([t,""],[Ql(t),""],!1,!0);return $u(e).qt(r).next(i=>{for(const o of i){if(o.collectionId!==t)break;s.push(We(o.parent))}return s})}addFieldIndex(e,t){const s=_r(e),r=function(i){return new Ue(i.indexId,i.collectionGroup,i.fields.map(o=>[o.fieldPath.canonicalString(),o.kind]))}(t);return delete r.indexId,s.add(r).next()}deleteFieldIndex(e,t){const s=_r(e),r=br(e),i=vr(e);return s.delete(t.indexId).next(()=>r.delete(IDBKeyRange.bound([t.indexId],[t.indexId+1],!1,!0))).next(()=>i.delete(IDBKeyRange.bound([t.indexId],[t.indexId+1],!1,!0)))}getDocumentsMatchingTarget(e,t,s){return p.resolve(U())}getFieldIndex(e,t){return p.resolve(null)}Oe(e,t){const s=new Vu;for(const r of function(i){return i.fields.filter(o=>o.kind!==2)}(e)){const i=t.data.field(r.fieldPath);if(i==null)return null;const o=s.Ne(r.kind);zr.le.Xt(i,o)}return s.Ve()}Me(e){const t=new Vu;return zr.le.Xt(e,t.Ne(0)),t.Ve()}getFieldIndexes(e,t){const s=_r(e),r=br(e);return(t?s.qt(Ue.collectionGroupIndex,IDBKeyRange.bound(t,t)):s.qt()).next(i=>{const o=[];return p.forEach(i,a=>r.get([a.indexId,this.uid]).next(c=>{o.push(function(u,h){const l=h?new jr(h.sequenceNumber,new Ei(en(h.readTime),new _(We(h.documentKey)),h.largestBatchId)):jr.empty(),d=u.fields.map(([g,m])=>new Pw(ie.fromServerFormat(g),m));return new ed(u.indexId,u.collectionGroup,d,l)}(a,c))})).next(()=>o)})}getNextCollectionGroupToUpdate(e){return this.getFieldIndexes(e).next(t=>t.length===0?null:(t.sort((s,r)=>s.indexState.sequenceNumber-r.indexState.sequenceNumber),t[0].collectionGroup))}updateCollectionGroup(e,t,s){const r=_r(e),i=br(e);return this.$e(e).next(o=>r.qt(Ue.collectionGroupIndex,IDBKeyRange.bound(t,t)).next(a=>p.forEach(a,c=>i.put(function(u,h,l,d){return new Ve(u,h.uid||"",l,Zt(d.readTime),oe(d.documentKey.path),d.largestBatchId)}(c.indexId,this.user,o,s)))))}updateIndexEntries(e,t){const s=new Map;return p.forEach(t,(r,i)=>{const o=s.get(r.collectionGroup);return(o?p.resolve(o):this.getFieldIndexes(e,r.collectionGroup)).next(a=>(s.set(r.collectionGroup,a),p.forEach(a,c=>this.Fe(e,r,c).next(u=>{const h=this.Be(i,c);return u.isEqual(h)?p.resolve():this.Le(e,i,u,h)}))))})}Ue(e,t,s){return vr(e).put(new qe(s.indexId,this.uid,s.arrayValue,s.directionalValue,oe(t.key.path)))}qe(e,t,s){return vr(e).delete([s.indexId,this.uid,s.arrayValue,s.directionalValue,oe(t.key.path)])}Fe(e,t,s){const r=vr(e);let i=new $(io);return r.Qt({index:qe.documentKeyIndex,range:IDBKeyRange.only([s.indexId,this.uid,oe(t.path)])},(o,a)=>{i=i.add(new ro(s.indexId,t,a.arrayValue,a.directionalValue))}).next(()=>i)}Be(e,t){let s=new $(io);const r=this.Oe(t,e);if(r==null)return s;const i=function(o){return o.fields.find(a=>a.kind===2)}(t);if(i!=null){const o=e.data.field(i.fieldPath);if(Ti(o))for(const a of o.arrayValue.values||[])s=s.add(new ro(t.indexId,e.key,this.Me(a),r))}else s=s.add(new ro(t.indexId,e.key,new Uint8Array,r));return s}Le(e,t,s,r){w("IndexedDbIndexManager","Updating index entries for document '%s'",t.key);const i=[];return function(o,a,c,u,h){const l=o.getIterator(),d=a.getIterator();let g=wn(l),m=wn(d);for(;g||m;){let b=!1,E=!1;if(g&&m){const M=c(g,m);M<0?E=!0:M>0&&(b=!0)}else g!=null?E=!0:b=!0;b?(u(m),m=wn(d)):E?(h(g),g=wn(l)):(g=wn(l),m=wn(d))}}(s,r,io,o=>{i.push(this.Ue(e,t,o))},o=>{i.push(this.qe(e,t,o))}),p.waitFor(i)}$e(e){let t=1;return br(e).Qt({index:Ve.sequenceNumberIndex,reverse:!0,range:IDBKeyRange.upperBound([this.uid,Number.MAX_SAFE_INTEGER])},(s,r,i)=>{i.done(),t=r.sequenceNumber+1}).next(()=>t)}}function $u(n){return le(n,Vt.store)}function vr(n){return le(n,qe.store)}function _r(n){return le(n,Ue.store)}function br(n){return le(n,Ve.store)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ld(n,e,t){const s=n.store(B.store),r=n.store(ve.store),i=[],o=IDBKeyRange.only(t.batchId);let a=0;const c=s.Qt({range:o},(h,l,d)=>(a++,d.delete()));i.push(c.next(()=>{C(a===1)}));const u=[];for(const h of t.mutations){const l=ve.key(e,h.key.path,t.batchId);i.push(r.delete(l)),u.push(h.key)}return p.waitFor(i).next(()=>u)}function Hr(n){if(!n)return 0;let e;if(n.document)e=n.document;else if(n.unknownDocument)e=n.unknownDocument;else{if(!n.noDocument)throw T();e=n.noDocument}return JSON.stringify(e).length}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vv{constructor(e,t){this.progress=e,this.ws=t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class V{constructor(e,t,s){this.converter=t,this._key=s,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Ze(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new V(this.firestore,e,this._key)}}class Te{constructor(e,t,s){this.converter=t,this._query=s,this.type="query",this.firestore=e}withConverter(e){return new Te(this.firestore,e,this._query)}}class Ze extends Te{constructor(e,t,s){super(e,t,Zn(s)),this._path=s,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new V(this.firestore,null,new _(e))}withConverter(e){return new Ze(this.firestore,e,this._path)}}function wf(n,e,...t){if(n=F(n),bc("collection","path",e),n instanceof ir){const s=L.fromString(e,...t);return ih(s),new Ze(n,null,s)}{if(!(n instanceof V||n instanceof Ze))throw new y(f.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=n._path.child(L.fromString(e,...t));return ih(s),new Ze(n.firestore,null,s)}}function cb(n,e){if(n=O(n,ir),bc("collectionGroup","collection id",e),e.indexOf("/")>=0)throw new y(f.INVALID_ARGUMENT,`Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);return new Te(n,null,function(t){return new dt(L.emptyPath(),t)}(e))}function Jr(n,e,...t){if(n=F(n),arguments.length===1&&(e=Wl.R()),bc("doc","path",e),n instanceof ir){const s=L.fromString(e,...t);return rh(s),new V(n,null,new _(s))}{if(!(n instanceof V||n instanceof Ze))throw new y(f.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=n._path.child(L.fromString(e,...t));return rh(s),new V(n.firestore,n instanceof Ze?n.converter:null,new _(s))}}function vf(n,e){return n=F(n),e=F(e),(n instanceof V||n instanceof Ze)&&(e instanceof V||e instanceof Ze)&&n.firestore===e.firestore&&n.path===e.path&&n.converter===e.converter}function _f(n,e){return n=F(n),e=F(e),n instanceof Te&&e instanceof Te&&n.firestore===e.firestore&&Xs(n._query,e._query)&&n.converter===e.converter}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fi(n,e,t){let s;return s=n?t&&(t.merge||t.mergeFields)?n.toFirestore(e,t):n.toFirestore(e):e,s}class Bb extends kc{constructor(e){super(),this.firestore=e}convertBytes(e){return new et(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new V(this.firestore,null,t)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uI={Firestore:Bf,GeoPoint:Pi,Timestamp:ce,Blob:Us,Transaction:Vf,WriteBatch:qf,DocumentReference:$e,DocumentSnapshot:Fs,Query:Se,QueryDocumentSnapshot:Bs,QuerySnapshot:Bo,CollectionReference:Kn,FieldPath:Dc,FieldValue:Pt,setLogLevel:aI,CACHE_SIZE_UNLIMITED:lb};function hI(n,e){n.INTERNAL.registerComponent(new at("firestore-compat",t=>{const s=t.getProvider("app-compat").getImmediate(),r=t.getProvider("firestore").getImmediate();return e(s,r)},"PUBLIC").setServiceProps(Object.assign({},uI)))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
