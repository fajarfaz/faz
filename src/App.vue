...
<Suspense>
  <template #default>
    <div :class="isDark ? 'dark' : '' " class="transition-colors  ease-out duration-700 ">
      <header class="fixed top-0  z-10 h-20" v-show="$route.path!=='/'"> 
        ...
        <nav class="fixed flex md:flex-row flex-col bg-white top-0 md:px-24 px-8 md:py-10 py-6 w-full  dark:dark-bg  border-b border-gray-200 dark:text-gray-100 app">
 ...
 <RouterView class="md:px-24 px-8 pt-[10em] dark:dark-bg dark:text-white app  min-h-screen" :isDark="isDark" @toggle="toggle" v-slot="{ Component }">
