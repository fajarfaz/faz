<template>
	<main class="w-11/12 grid gap-28">
		<div class="flex flex-col space-y-2 items-center justify-center text-lg"> 
		...
		<div class="flex flex-row space-x-10  hover:shadow-md rounded-2xl duration-300">
			...
			<div class="w-6/12 flex flex-col space-y-10 my-auto p-4">
				...
				<div class="flex flex-col space-y-4">
					...
					<div class="flex flex-row px-4 space-x-8">
		...
		<div class="flex flex-row space-x-10  hover:shadow-md rounded-2xl duration-300 flex-row-reverse space-x-reverse">
			<div class="w-6/12 relative">
			...
			<div class="w-6/12 flex flex-col space-y-10 my-auto p-4">
				...
				<div class="flex flex-col space-y-4">
					...
					<div class="flex flex-row px-4 space-x-8">
						<img src="../assets/laravel.png" class="object-contain w-12">
						<img src="../assets/bootstrap.png" class="object-contain w-12">
						<img src="../assets/mysql.png" class="object-contain w-12">
						<img src="../assets/alpine.png" class="object-contain w-12">
						<img src="../assets/node.png" class="object-contain w-12">
					</div>
			...
			<div class="w-6/12 flex flex-col space-y-10 my-auto p-4">
				...
				<div class="flex flex-col space-y-4">
					...
					<div class="flex flex-row px-4 space-x-8">
						...
						<img src="../assets/mysql.png" class="object-contain w-12">
						<img src="../assets/alpine.png" class="object-contain w-12">
						<img src="../assets/jetstream.png" class="object-contain w-24">
					</div>
				</div>
			</div>			
		</div>
		...
		<div class="flex flex-row space-x-10  hover:shadow-md rounded-2xl duration-300 flex-row space-x">
			<div class="w-6/12 relative">
